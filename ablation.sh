...
#SBATCH --output=/home/anthony.li/out/ablation.%A.%a.out
#SBATCH --error=/home/anthony.li/out/ablation.%A.%a.err
...
for i in $(seq $start_command $end_command); do
    command=$(sed -n "${i}p" ablation-commands.sh)
