...
python extra-demo.py --token_file "results/ml3-concat-text5-gumbel.p" --model meta-llama/Meta-Llama-3-8B --seed 1 &
python extra-demo.py --token_file "results/ml3-concat-french-text5-gumbel.p" --model meta-llama/Meta-Llama-3-8B --seed 1 &
